...
El rover recibe una cadena de comandos, donde cada carácter es una instrucción:
 ...
 - M: avanza una casilla en la dirección en la que está orientado, manteniendo la orientación.

### Reglas de movimiento

Cuando el rover avanza (M), su nueva posición se calcula según la orientación:
